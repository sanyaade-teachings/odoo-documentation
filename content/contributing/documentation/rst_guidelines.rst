...
XXX add here the instructions and then change the headings so they don't include verbs!
...
.. example::
   ...
   A reference to the :file:`prices.rst` and :file:`variants.rst` could be made from
...
XXXDon't use non-descriptive links
----------------------------------

Don't: Please refer to `this documentation <https://example.com/doc/accounting/invoices.html>`_
Do:	Please refer to `the invoicing documentation <https://example.com/doc/accounting/invoices.html>`_
...
.. tip::
   - You can safely break a line after any space, even inside markups such as ``menuselection`` and
     ``doc``.
...
.. list-table::
   ...
   * - Please refer to `the Invoicing documentation <https://example.com/doc/accounting/invoices.html>`_
       and to `Send a pro-forma invoice <https://example.com/doc/sales/proforma.html>`_.
